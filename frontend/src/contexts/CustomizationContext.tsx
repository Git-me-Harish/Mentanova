...
interface CustomizationContextType {
  ...
  applyCustomizationDirectly: (customization: Customization) => void;  // NEW METHOD
...
export function CustomizationProvider({ children }: { children: ReactNode }) {
  ...
  // NEW METHOD: Apply customization without making an API call
  // This is perfect for when you just saved and already have the fresh data
  const applyCustomizationDirectly = (customizationData: Customization) => {
    console.log('⚡ Applying customization directly (no API call)');
    setCustomization(customizationData);
    const currentDarkMode = localStorage.getItem('darkMode') === 'true';
    applyTheme(customizationData, currentDarkMode);
  };
  ...
  const value = {
    ...
    applyTheme,
    applyCustomizationDirectly,  // Export the new method
    validateTheme,
    generateDarkMode,
  };
