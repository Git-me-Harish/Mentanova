...
import { User, Mail, Shield, Calendar, Settings, Save, Loader2, CheckCircle, Lock, UserCircle, Building2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto py-4 sm:py-8 px-3 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 mb-2">
            <UserCircle className="w-6 h-6 sm:w-8 sm:h-8 text-primary-600" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4 sm:mt-6">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg sm:col-span-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm sm:text-base font-medium text-gray-900">
                    {user.organization?.display_name || user.organization?.name || 'Not assigned'}
                  </p>
