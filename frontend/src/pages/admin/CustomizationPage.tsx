...
export default function CustomizationPage() {
  const { refreshCustomization, validateTheme, generateDarkMode, darkMode, toggleDarkMode, applyCustomizationDirectly } = useCustomization();
  ...
  const organizationName = 'Mentanova ';
  ...
  const handleApplyPreset = async (presetName: string) => {
    ...
    try {
      ...
      // The preset response includes the customization object!
      if (response.customization) {
        // Apply it directly - no extra API calls needed!
        applyCustomizationDirectly(response.customization);
        
        // Update the form to reflect the new preset
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Apply immediately without extra API call!
      applyCustomizationDirectly(response);
