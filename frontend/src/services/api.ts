...
class ApiService {
  ...
  async getAdminCustomization(): Promise<Customization> {
  ...
  async resetCustomization(): Promise<any> {
    const response = await this.api.post('/admin/customization/reset');
    return response.data;
  }
  ...
  async applyThemePreset(presetName: string): Promise<any> {
  ...
  async exportCustomization(): Promise<Customization> {
  ...
  async createOrganization(data: CreateOrganizationRequest): Promise<any> {
    const response = await this.api.post('/super-admin/organizations', data);
    return response.data;
  }
  ...
  async listOrganizations(params?: {
    ...
    const response = await this.api.get('/super-admin/organizations', { params });
    return response.data;
  }

  async getOrganizationDetails(organizationId: string): Promise<OrganizationDetails> {
    const response = await this.api.get(`/super-admin/organizations/${organizationId}`);
    return response.data;
  }
  ...
  async updateOrganization(
    ...
    const response = await this.api.put(`/super-admin/organizations/${organizationId}`, data);
    return response.data;
  }

  async deleteOrganization(organizationId: string): Promise<void> {
    await this.api.delete(`/super-admin/organizations/${organizationId}`);
  }
  ...
  async getOrganizationUsers(
    ...
    const response = await this.api.get(
      `/super-admin/organizations/${organizationId}/users`,
      { params }
    );
    return response.data;
  }
  ...
  async assignOrganizationAdmin(
    ...
    const response = await this.api.post(
      `/super-admin/organizations/${organizationId}/assign-admin`,
      null,
  ...
  async revokeOrganizationAdmin(
    ...
    const response = await this.api.post(
      `/super-admin/organizations/${organizationId}/revoke-admin`,
      null,
      { params: { user_id: userId } }
    );
    return response.data;
  ...
  async getSuperAdminStatistics(): Promise<SuperAdminStats> {
    const response = await this.api.get('/super-admin/statistics');
    return response.data;
  }
