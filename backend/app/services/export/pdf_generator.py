...
class EnhancedPDFGenerator:
    ...
    def generate_conversation_pdf(
        ...
        doc = SimpleDocTemplate(
            ...
            topMargin=60,
            bottomMargin=60,
            title=f"Mentanova Conversation {conversation['id'][:8]}"
        )
    ...
    def _create_header_section(self, conversation: Dict[str, Any]) -> List:
        ...
        # Title
        title = Paragraph(
            "Mentanova AI<br/>Conversation Export",
    ...
    def _create_footer(self) -> List:
        ...
        footer_text = Paragraph(
            f"<i>Generated by Mentanova AI • {datetime.now().strftime('%B %d, %Y')} • Confidential</i>",
